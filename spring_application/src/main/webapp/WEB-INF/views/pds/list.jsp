			...
			<div class="card-header with-border">
				...
				<div id="keyword" class="card-tools" style="width:450px;">	
					<div class="input-group row">
						<select class="form-control col-md-3" name="perPageNum" id="perPageNum" onchange="searckList_go(1);">
					  		<option value="10" ${command.perPageNum==10 ? 'selected':'' } >정렬개수</option>
					  		<option value="20" ${command.perPageNum==20 ? 'selected':'' }>20개씩</option>
					  		<option value="30" ${command.perPageNum==30 ? 'selected':'' }>30개씩</option>
